                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Beschreibung">
                     ...
                     <asp:TemplateField HeaderText="Datum">
                         <EditItemTemplate>
                            <asp:TextBox ID="txtEditItemTemplateProjectDate" runat="server" Text='<%#Bind("DATE")%>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblItemTemplateProjectDate" runat="server" Text='<%# Convert.ToDateTime(Eval("DATE")).ToString("dd/MM/yyyy")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Kapazität"> 
                     ...
                     <asp:TemplateField HeaderText="ID Verantwortlicher">
                         <ItemTemplate>
                    ...
                    <ItemTemplate>
                            <asp:ImageButton ID="btnEdit" runat="server" CommandName="Edit" ImageUrl="~/App_Themes/default/edit.png"   />
                        </ItemTemplate>
                    <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Löschen">
                        <ItemTemplate>
                            <asp:ImageButton ID="btnDelete" runat="server" CommandName="Delete" ImageUrl="~/App_Themes/default/trash.png"   />
                        </ItemTemplate>                   
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
            <asp:Button ID="btnUserManagement" runat="server" Text="Zur Userverwaltung" />
